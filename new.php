	    ...
	    /*$cuerpo_m = '
	       <html>
            ...
            <body>
				...
				<tr>
					<td style="background-color:#f7d358;font-family:Calibri"><b>Descripci��n</b></td>
				...
				<tr>
					<td style="background-color:#f7d358;font-family:Calibri"><b>Fecha Revisi��n</b></td>
...
if ($opc == "Guardar y Descargar como Excel")
{
	...
	<tr>
	<td colspan = 2 style = 'text-align: center; border: 1px solid black'>Descripción: $des</td>
	<td style = 'border: 1px solid black'>Guatemala Guatemala City-100</td>
	</tr>
	<tr>
	<td colspan = 3 style = 'border: 1px solid black'>Tracking $tra</td>
